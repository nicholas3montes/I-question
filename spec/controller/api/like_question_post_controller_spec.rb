...
describe 'LikeQuestionPostsController', type: :request do
  context 'Reação de like no question post ' do
    it 'like acontece' do
      #Setup
      ...
      #Execution
      post api_like_question_post_index_path, params: {question_post_id: QuestionPost.last.id, user_id: User.last.id}
    ...
    it 'Dono do question post tenta curtir propria question post e não consegue' do
      #Setup
      ...
      #Execution
      post api_like_question_post_index_path, params: {question_post_id: QuestionPost.last.id, user_id: user.id}
